...
{
    public class TaskService : RCSAppService, ITaskService
    {
        ...
        private readonly RCS.Configuration.ThirdParty.TM _tm;
        ...
        public async Task CancelTaskAsync(string[] ids)
        {
            ...
            var dto = new
            {
                delete_task_count = 1,
                delete_flag = 0,
                sub_tasks = tasks.Select(x => new { task_serial = x.Id + "_Fetch1", AGV_serial = 0 }).ToArray(),
            };
