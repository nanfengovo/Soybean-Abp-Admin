...
namespace AbpOverallAuth.LogManage
{
        ...
        InternalApiLogPagedRequestDto>
    {
        ...
        {
            // 配置权限（如果需要）
            // GetPolicyName = AbpOverallAuthPermissions.InternalApiLog.Default;
            // GetListPolicyName = AbpOverallAuthPermissions.InternalApiLog.Default;
        }
