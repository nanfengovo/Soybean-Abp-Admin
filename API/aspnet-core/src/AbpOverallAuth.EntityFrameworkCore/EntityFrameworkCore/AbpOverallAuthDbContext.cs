...
public class AbpOverallAuthDbContext :
    AbpDbContext<AbpOverallAuthDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(AbpOverallAuthConsts.DbTablePrefix + "YourEntities", AbpOverallAuthConsts.DbSchema);
