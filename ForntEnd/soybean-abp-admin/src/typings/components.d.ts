...
declare global {
  ...
  const IconMdiThemeLightDark: typeof import('~icons/mdi/theme-light-dark')['default']
  const IconMdiUpload: typeof import('~icons/mdi/upload')['default']
  const IconMdiWhiteBalanceSunny: typeof import('~icons/mdi/white-balance-sunny')['default']
