const local: App.I18n.Schema = {
  ...
  route: {
    ...
    system_agvmap: 'AGV Map'
  },
  page: {
    agvMap: {
      title: 'AGV Dispatch Monitoring System',
      ...
      zoomIn: 'Zoom In',
      zoomOut: 'Zoom Out',
      instructions: 'Shift+Drag to Pan | Scroll to Zoom',
      onlineDevices: 'Online Devices',
      zoom: 'Zoom',
      routeManagement: 'Route Management',
      addRoute: 'Add',
      agvStatus: 'AGV Vehicle Status',
      agvName: 'Name',
      ...
      statusPaused: 'Paused',
      nodes: 'Nodes',
      importSuccess: 'Map file imported successfully',
      importError: 'Failed to parse map file, please check the file format',
